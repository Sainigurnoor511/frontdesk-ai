...
export default async function HomePage() {
  ...
  const priorRange = getPriorDateRange('7d')
  ...
  const [
    ...
    getOverviewMetrics(context.org.id, priorRange.startDate, priorRange.endDate),
  ...
  return (
    <HomeClient
      ...
      priorMetrics={{
        calls: priorCallStats.totalCalls,
        bookings: priorOverview.bookings,
        revenue: priorOverview.revenue,
        newClients: priorOverview.newClients,
      }}
